...
export default class AddSheet extends React.Component {
    ...
    updateFormField = (evt) => {
     ...
     addSheet = async () => {
    let response = await axios.post('/all_sheet',{
          'title': this.state.original.songName,
          'ingredients':this.state.original.composer
    })
...
//                             </div>
//                             <Button type='submit' className='btn btn-success mt-4' onClick={handleSubmit}>Add Sheet</Button>
//                         </div>
//                     </Modal.Body>
//                     <Modal.Footer>
